# This Makefile is for the Wiki::Toolkit::Formatter::Markdown extension to perl.
#
...
#     ABSTRACT => q[[One line description of module's purpose here]]
#     AUTHOR => q[Chris Prather  C<< <perigrin@cpan.org> >>]
#     DIR => []
#     DISTNAME => q[Wiki-Toolkit-Formatter-Markdown]
#     NAME => q[Wiki::Toolkit::Formatter::Markdown]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0.42], Mouse=>q[0.10], ExtUtils::MakeMaker=>q[6.42], Text::Markdown=>q[1.0.22] }
#     VERSION => q[0.0.1]
...
NAME_SYM = Wiki_Toolkit_Formatter_Markdown
VERSION = 0.0.1
...
MAKE = make
FULLEXT = Wiki/Toolkit/Formatter/Markdown
BASEEXT = Markdown
PARENT_NAME = Wiki::Toolkit::Formatter
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Wiki/Toolkit/Formatter/Markdown.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Wiki/Toolkit/Formatter
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Wiki/Toolkit/Formatter
...
TO_INST_PM = lib/Wiki/Toolkit/Formatter/Markdown.pm

PM_TO_BLIB = lib/Wiki/Toolkit/Formatter/Markdown.pm \
...
DISTNAME = Wiki-Toolkit-Formatter-Markdown
DISTVNAME = Wiki-Toolkit-Formatter-Markdown-0.0.1
...
manifypods : pure_all  \
	lib/Wiki/Toolkit/Formatter/Markdown.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Wiki/Toolkit/Formatter/Markdown.pm $(INST_MAN3DIR)/Wiki::Toolkit::Formatter::Markdown.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>[One line description of module'\''s purpose here]</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Mouse" VERSION="0,10,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Test-More" VERSION="0,42,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Text-Markdown" VERSION="1,0,22,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Wiki/Toolkit/Formatter/Markdown.pm blib/lib/Wiki/Toolkit/Formatter/Markdown.pm 
